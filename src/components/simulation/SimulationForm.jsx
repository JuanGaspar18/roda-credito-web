...
import { simulateCredit } from "../../api/simulation.api";

const SimulationForm = ({ onSimulate }) => {

    const [vehicleType, setVehicleType] = useState("Moto eléctrica");
    const [vehicleValue, setVehicleValue] = useState(8000000);
    ...
    const handleCalculate = async () => {
        ...
        try {
            const response = await simulateCredit(payload);
            if (response.success) {
    ...
    return (
        <div className="card-primary p-8 lg:p-10">
            ...
            <div className="flex flex-col gap-10">
                ...
                <button onClick={handleCalculate} className="button-primary mt-4 w-full">
