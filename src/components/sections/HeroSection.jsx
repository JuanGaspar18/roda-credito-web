        ...
        <section className="relative overflow-hidden py-22">
            ...
            <div className="container-primary relative z-10">
                <div className="mx-auto flex max-w-5xl flex-col items-center text-center">
                    <div className="mb-8 rounded-full border px-5 py-2 text-sm font-medium" style={{ background: "var(--gradient-primary)", borderColor:"rgba(212,255,0,0.15)", color:"var(--color-accent-text)"}}>
                        ⚡ Financiamiento para movilidad eléctrica
                    </div>
                    <h2 className="text-display section-title max-w-4xl">
                        Simula tu crédito para <br /> <span style={{color:"var(--color-primary)"}}> vehículos eléctricos </span>
                    </h2>
                    <p className="text-subtitle section-description mt-8 max-w-2xl">
